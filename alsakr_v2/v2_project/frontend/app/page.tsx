...
export default function LandingPage() {
    return (
        <div className="min-h-screen bg-gradient-to-b from-white to-blue-50">
            ...
            <header className="max-w-6xl mx-auto px-6 py-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold text-gray-900">Al Sakr <span className="text-blue-500">AI</span></span>
                    </div>
            ...
            <main className="max-w-4xl mx-auto px-6 py-20 text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-20">
                    ...
                    <a
                        ...
                        className="inline-flex items-center justify-center gap-2 bg-white hover:bg-gray-50 text-gray-900 px-8 py-4 rounded-xl font-medium border border-gray-200 transition-all"
                    >
                        For Vendors
                    </a>
                </div>
            ...
            {/* Footer */}
            <footer className="max-w-6xl mx-auto px-6 py-8 border-t border-gray-200 mt-20">
