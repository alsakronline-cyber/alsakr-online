...
export default function VendorDashboard() {
    ...
    return (
        <div className="min-h-screen bg-slate-50 text-slate-900 flex font-sans">
            {/* Sidebar - Same as Command Center for consistency */}
            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="h-16 bg-white border-b border-slate-200 px-8 flex items-center justify-between shadow-sm z-10">
                    <h1 className="text-sm font-bold text-slate-700 uppercase tracking-wide">Vendor Portal <span className="text-blue-200 mx-2">|</span> Inquiries</h1>
                    ...
                    <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
                        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                            <h2 className="font-bold text-slate-700 flex items-center gap-2">
                                ...
                                Incoming Requests ({inquiries.length})
                            </h2>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody className="divide-y divide-slate-100">
                                    {loading ? (
                                        <tr><td colSpan={6} className="px-6 py-8 text-center text-slate-400">Loading inquiries...</td></tr>
                                    ) : inquiries.length === 0 ? (
                                        <tr><td colSpan={6} className="px-6 py-8 text-center text-slate-400">No new inquiries found.</td></tr>
                                    ) : (
